...
const GithubIcon: React.FC = () => {
  return (
    <a href="https://github.com/j2yn34" target="_blank" data-tip="github" className="tooltip ml-1">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="dark:bg-gray-900 bg-gray-100 text-inherit p-10 footer footer-center">
      <p>
        <a
          rel="noreferrer noopener external"
      ...
      <p>Copyright © 2024 Bang JooYeong</p>
    </footer>
  );
};
